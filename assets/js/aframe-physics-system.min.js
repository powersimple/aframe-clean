! function () {
    ...
    4: [function (require, module, exports) {
        ...
        var ObjectCollisionMatrix = function () {
            ...
            Mat3 = function () {
                function Mat3(elements) {
                    void 0 === elements && (elements = [0, 0, 0, 0, 0, 0, 0, 0, 0]), this.elements = elements
                }
                ...
                return _proto.identity = function () {
                    ...
                    void 0 === target && (target = new Mat3);
                    for (var e = this.elements, t = target.elements, i = 0; 3 !== i; i++) t[3 * i + 0] = vector.x * e[3 * i + 0], t[3 * i + 1] = vector.y * e[3 * i + 1], t[3 * i + 2] = vector.z * e[3 * i + 2];
                    return target
            ...
            Vec3 = function () {
                function Vec3(x, y, z) {
                    void 0 === x && (x = 0), void 0 === y && (y = 0), void 0 === z && (z = 0), this.x = x, this.y = y, this.z = z
                }
                ...
                return _proto.cross = function (vector, target) {
                    ...
                    var vx = vector.x,
                        ...
                        y = this.y,
                        z = this.z;
                    return target.x = y * vz - z * vy, target.y = z * vx - x * vz, target.z = x * vy - y * vx, target
                    ...
                    return void 0 === target && (target = new Vec3), target.x = vector.x * this.x, target.y = vector.y * this.y, target.z = vector.z * this.z, target
                }, _proto.addScaledVector = function (scalar, vector, target) {
                    return void 0 === target && (target = new Vec3), target.x = this.x + scalar * vector.x, target.y = this.y + scalar * vector.y, target.z = this.z + scalar * vector.z, target
                }, _proto.dot = function (vector) {
                    return this.x * vector.x + this.y * vector.y + this.z * vector.z
                }, _proto.isZero = function () {
                    return 0 === this.x && 0 === this.y && 0 === this.z
                }, _proto.negate = function (target) {
                    return void 0 === target && (target = new Vec3), target.x = -this.x, target.y = -this.y, target.z = -this.z, target
                    ...
                    return this.x = vector.x, this.y = vector.y, this.z = vector.z, this
                }, _proto.lerp = function (vector, t, target) {
                    var x = this.x,
                        y = this.y,
                        z = this.z;
                    target.x = x + (vector.x - x) * t, target.y = y + (vector.y - y) * t, target.z = z + (vector.z - z) * t
        ...
        var Vec3_tangents_n = new Vec3,
            ...
            AABB = function () {
                function AABB(options) {
                    void 0 === options && (options = {}), this.lowerBound = new Vec3, this.upperBound = new Vec3, options.lowerBound && this.lowerBound.copy(options.lowerBound), options.upperBound && this.upperBound.copy(options.upperBound)
                }
                ...
                return _proto.setFromPoints = function (points, position, quaternion, skinSize) {
                    ...
                    var l = this.lowerBound,
                        u = this.upperBound;
                    a.copy(l), b.set(u.x, l.y, l.z), c.set(u.x, u.y, l.z), d.set(l.x, u.y, u.z), e.set(u.x, l.y, u.z), f.set(l.x, u.y, l.z), g.set(l.x, l.y, u.z), h.copy(u)
        ...
        var EventTarget = function () {
                ...
                return _proto.addEventListener = function (type, listener) {
                    ...
                    return void 0 === listeners[type] && (listeners[type] = []), listeners[type].includes(listener) || listeners[type].push(listener), this
            ...
            Quaternion = function () {
                function Quaternion(x, y, z, w) {
                    void 0 === x && (x = 0), void 0 === y && (y = 0), void 0 === z && (z = 0), void 0 === w && (w = 1), this.x = x, this.y = y, this.z = z, this.w = w
                }
                ...
                return _proto.set = function (x, y, z, w) {
                    ...
                    return this.x = vector.x * s, this.y = vector.y * s, this.z = vector.z * s, this.w = Math.cos(.5 * angle), this
                    ...
                    if (u.isAntiparallelTo(v)) {
                        ...
                        var a = u.cross(v);
                        this.x = a.x, this.y = a.y, this.z = a.z, this.w = Math.sqrt(Math.pow(u.length(), 2) * Math.pow(v.length(), 2)) + u.dot(v), this.normalize()
                    }
                    return this
                    ...
                    return void 0 === target && (target = new Quaternion), target.x = -this.x, target.y = -this.y, target.z = -this.z, target.w = this.w, target
                }, _proto.normalize = function () {
                    ...
                    return this.x = quat.x, this.y = quat.y, this.z = quat.z, this.w = quat.w, this
        ...
        var Transform = function () {
                function Transform(options) {
                    void 0 === options && (options = {}), this.position = new Vec3, this.quaternion = new Quaternion, options.position && this.position.copy(options.position), options.quaternion && this.quaternion.copy(options.quaternion)
                }
                ...
                return _proto.pointToLocal = function (worldPoint, result) {
                    ...
                    return void 0 === result && (result = new Vec3), this.quaternion.vmult(localVector, result), result
                }, Transform.pointToLocalFrame = function (position, quaternion, worldPoint, result) {
                    return void 0 === result && (result = new Vec3), worldPoint.vsub(position, result), quaternion.conjugate(tmpQuat), tmpQuat.vmult(result, result), result
                }, Transform.pointToWorldFrame = function (position, quaternion, localPoint, result) {
                    return void 0 === result && (result = new Vec3), quaternion.vmult(localPoint, result), result.vadd(position, result), result
                }, Transform.vectorToWorldFrame = function (quaternion, localVector, result) {
                    return void 0 === result && (result = new Vec3), quaternion.vmult(localVector, result), result
                }, Transform.vectorToLocalFrame = function (position, quaternion, worldVector, result) {
                    return void 0 === result && (result = new Vec3), quaternion.w *= -1, quaternion.vmult(worldVector, result), quaternion.w *= -1, result
                }, Transform
            }(),
            ...
            ConvexPolyhedron = function (_Shape) {
                ...
                return _proto.computeEdges = function () {
                    ...
                    for (var vi = 0; vi < numVerts; vi++) {
                        if (lastVertex = inVertices[vi], n_dot_last = planeNormal.dot(lastVertex) + planeConstant, n_dot_first < 0)
                            if (n_dot_last < 0) {
                                ...
                                var _newv = new Vec3;
                                firstVertex.lerp(lastVertex, n_dot_first / (n_dot_first - n_dot_last), _newv), outVertices.push(_newv)
                            }
                        else if (n_dot_last < 0) {
                            var _newv2 = new Vec3;
                            firstVertex.lerp(lastVertex, n_dot_first / (n_dot_first - n_dot_last), _newv2), outVertices.push(_newv2), outVertices.push(lastVertex)
                        }
                    ...
                    for (var verts = this.vertices, worldVerts = this.worldVertices, i = 0; i !== this.vertices.length; i++) quat.vmult(verts[i], worldVerts[i]), position.vadd(worldVerts[i], worldVerts[i]);
                    ...
                    for (var minx, miny, minz, maxx, maxy, maxz, verts = this.vertices, tempWorldVertex = new Vec3, i = 0; i < verts.length; i++) {
                        ...
                        (void 0 === minx || v.x < minx) && (minx = v.x), (void 0 === maxx || v.x > maxx) && (maxx = v.x), (void 0 === miny || v.y < miny) && (miny = v.y), (void 0 === maxy || v.y > maxy) && (maxy = v.y), (void 0 === minz || v.z < minz) && (minz = v.z), (void 0 === maxz || v.z > maxz) && (maxz = v.z)
                    }
        ...
        var Box = function (_Shape) {
            function Box(halfExtents) {
                ...
                }) || this).halfExtents = halfExtents, _this.convexPolyhedronRepresentation = null, _this.updateConvexPolyhedronRepresentation(), _this.updateBoundingSphereRadius(), _this
            }
            ...
            return _proto.updateConvexPolyhedronRepresentation = function () {
                ...
                return void 0 === target && (target = new Vec3), Box.calculateInertia(this.halfExtents, mass, target), target
                ...
                for (var i = 1; i < 8; i++) {
                    ...
                    var _x = _wc.x,
                        _y = _wc.y,
                        _z = _wc.z;
                    _x > max.x && (max.x = _x), _y > max.y && (max.y = _y), _z > max.z && (max.z = _z), _x < min.x && (min.x = _x), _y < min.y && (min.y = _y), _z < min.z && (min.z = _z)
                }
            }, Box
        }(Shape);
        ...
        var worldCornerTempPos = new Vec3,
            ...
            Body = function (_EventTarget) {
                ...
                return _proto.wakeUp = function () {
                    ...
                    return void 0 === result && (result = new Vec3), worldPoint.vsub(this.position, result), this.quaternion.conjugate().vmult(result, result), result
                }, _proto.vectorToLocalFrame = function (worldVector, result) {
                    return void 0 === result && (result = new Vec3), this.quaternion.conjugate().vmult(worldVector, result), result
                }, _proto.pointToWorldFrame = function (localPoint, result) {
                    return void 0 === result && (result = new Vec3), this.quaternion.vmult(localPoint, result), result.vadd(this.position, result), result
                }, _proto.vectorToWorldFrame = function (localVector, result) {
                    return void 0 === result && (result = new Vec3), this.quaternion.vmult(localVector, result), result
                    ...
                    for (var shapes = this.shapes, shapeOffsets = this.shapeOffsets, shapeOrientations = this.shapeOrientations, N = shapes.length, offset = tmpVec, orientation = tmpQuat$1, bodyQuat = this.quaternion, aabb = this.aabb, shapeAABB = computeAABB_shapeAABB, i = 0; i !== N; i++) {
                        var shape = shapes[i];
                        bodyQuat.vmult(shapeOffsets[i], offset), offset.vadd(this.position, offset), bodyQuat.mult(shapeOrientations[i], orientation), shape.calculateWorldAABB(offset, orientation, shapeAABB.lowerBound, shapeAABB.upperBound), 0 === i ? aabb.copy(shapeAABB) : aabb.extend(shapeAABB)
                    }
        ...
        Body.COLLIDE_EVENT_NAME = "collide", Body.DYNAMIC = 1, Body.STATIC = 2, Body.KINEMATIC = 4, Body.AWAKE = BODY_SLEEP_STATES.AWAKE, Body.SLEEPY = BODY_SLEEP_STATES.SLEEPY, Body.SLEEPING = BODY_SLEEP_STATES.SLEEPING, Body.idCounter = 0, Body.wakeupEvent = {
            type: "wakeup"
        }, Body.sleepyEvent = {
            type: "sleepy"
        }, Body.sleepEvent = {
        ...
        var GridBroadphase = function (_Broadphase) {
                function GridBroadphase(aabbMin, aabbMax, nx, ny, nz) {
                    var _this;
                    void 0 === aabbMin && (aabbMin = new Vec3(100, 100, 100)), void 0 === aabbMax && (aabbMax = new Vec3(-100, -100, -100)), void 0 === nx && (nx = 10), void 0 === ny && (ny = 10), void 0 === nz && (nz = 10), (_this = _Broadphase.call(this) || this).nx = nx, _this.ny = ny, _this.nz = nz, _this.aabbMin = aabbMin, _this.aabbMax = aabbMax;
                    var nbins = _this.nx * _this.ny * _this.nz;
                    if (nbins <= 0) throw "GridBroadphase: Each dimension's n must be >0";
                    _this.bins = [], _this.binLengths = [], _this.bins.length = nbins, _this.binLengths.length = nbins;
            ...
            NaiveBroadphase = (new Vec3, function (_Broadphase) {
                ...
                return _proto.collisionPairs = function (world, pairs1, pairs2) {
                    for (var bi, bj, bodies = world.bodies, n = bodies.length, i = 0; i !== n; i++)
                        for (var j = 0; j !== i; j++) bi = bodies[i], bj = bodies[j], this.needBroadphaseCollision(bi, bj) && this.intersectionTest(bi, bj, pairs1, pairs2)
                ...
                return _proto.intersectWorld = function (world, options) {
                    ...
                    if ((!checkCollisionResponse || body.collisionResponse) && 0 != (this.collisionFilterGroup & body.collisionFilterMask) && 0 != (body.collisionFilterGroup & this.collisionFilterMask))
                        for (var xi = intersectBody_xi, qi = intersectBody_qi, i = 0, N = body.shapes.length; i < N; i++) {
                            ...
                            if ((!checkCollisionResponse || shape.collisionResponse) && (body.quaternion.mult(body.shapeOrientations[i], qi), body.quaternion.vmult(body.shapeOffsets[i], xi), xi.vadd(body.position, xi), this.intersectShape(shape, qi, xi, body), this.result.shouldStop)) break
                        }
                    ...
                    if (!(function (from, direction, position) {
                            ...
                            return direction.scale(dot, intersect), intersect.vadd(from, intersect), position.distanceTo(intersect)
                    ...
                    var lowerBound = aabb.lowerBound,
                        ...
                        to = this.to,
                        from = this.from;
                    lowerBound.x = Math.min(to.x, from.x), lowerBound.y = Math.min(to.y, from.y), lowerBound.z = Math.min(to.z, from.z), upperBound.x = Math.max(to.x, from.x), upperBound.y = Math.max(to.y, from.y), upperBound.z = Math.max(to.z, from.z)
                    ...
                    localRay.from.copy(this.from), localRay.to.copy(this.to), Transform.pointToLocalFrame(position, quat, localRay.from, localRay.from), Transform.pointToLocalFrame(position, quat, localRay.to, localRay.to), localRay.updateDirection();
                    ...
                    for (var i = iMinX; i < iMaxX; i++)
                        for (var j = iMinY; j < iMaxY; j++) {
                            ...
                            if (shape.getAabbAtIndex(i, j, aabb), aabb.overlapsRay(localRay)) {
                                if (shape.getConvexTrianglePillar(i, j, !1), Transform.pointToWorldFrame(position, quat, shape.pillarOffset, worldPillarOffset), this._intersectConvex(shape.pillarConvex, quat, worldPillarOffset, body, reportedShape, intersectConvexOptions), this.result.shouldStop) return;
                                shape.getConvexTrianglePillar(i, j, !0), Transform.pointToWorldFrame(position, quat, shape.pillarOffset, worldPillarOffset), this._intersectConvex(shape.pillarConvex, quat, worldPillarOffset, body, reportedShape, intersectConvexOptions)
                            }
                        }
                    ...
                    if (!(delta < 0))
                        if (0 === delta) from.lerp(to, delta, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1);
                            ...
                            if (d1 >= 0 && d1 <= 1 && (from.lerp(to, d1, intersectionPoint), intersectionPoint.vsub(position, normal), normal.normalize(), this.reportIntersection(normal, intersectionPoint, reportedShape, body, -1)), this.result.shouldStop) return;
                    ...
                    for (var normal = intersectConvex_normal, vector = intersectConvex_vector, faceList = options && options.faceList || null, faces = shape.faces, vertices = shape.vertices, normals = shape.faceNormals, direction = this.direction, from = this.from, to = this.to, fromToDistance = from.distanceTo(to), Nfaces = faceList ? faceList.length : faces.length, result = this.result, j = 0; !result.shouldStop && j < Nfaces; j++) {
                        ...
                        if (!(Math.abs(dot) < this.precision)) {
                            ...
                            if (!(scalar < 0)) {
                                direction.scale(scalar, intersectPoint), intersectPoint.vadd(from, intersectPoint), a.copy(vertices[face[0]]), q.vmult(a, a), x.vadd(a, a);
                    ...
                    var from = this.from,
                        ...
                        result = this.result;
                    if (!(this.skipBackfaces && normal.dot(this.direction) > 0)) switch (result.hitFaceIndex = void 0 !== hitFaceIndex ? hitFaceIndex : -1, this.mode) {
                        case Ray.ALL:
                        ...
                        case Ray.CLOSEST:
                            ...
                            break;
                        case Ray.ANY:
                            this.hasHit = !0, result.hasHit = !0, result.set(from, to, normal, hitPointWorld, shape, body, distance), result.shouldStop = !0
                    }
                }, Ray
            }();
        ...
        var SAPBroadphase = function (_Broadphase) {
            function SAPBroadphase(world) {
                var _this;
                (_this = _Broadphase.call(this) || this).axisList = [], _this.world = null, _this.axisIndex = 0;
                ...
                return _this._addBodyHandler = function (event) {
                    ...
                    var idx = axisList.indexOf(event.body); - 1 !== idx && axisList.splice(idx, 1)
            ...
            return _proto.setWorld = function (world) {
                ...
                void 0 === result && (result = []), this.dirty && (this.sortList(), this.dirty = !1);
        ...
        var JacobianElement = function () {
            ...
            Equation = function () {
                function Equation(bi, bj, minForce, maxForce) {
                    void 0 === minForce && (minForce = -1e6), void 0 === maxForce && (maxForce = 1e6), this.id = Equation.id++, this.minForce = minForce, this.maxForce = maxForce, this.bi = bi, this.bj = bj, this.a = 0, this.b = 0, this.eps = 0, this.jacobianElementA = new JacobianElement, this.jacobianElementB = new JacobianElement, this.enabled = !0, this.multiplier = 0, this.setSpookParams(1e7, 4, 1 / 60)
                }
                ...
                return _proto.setSpookParams = function (stiffness, relaxation, timeStep) {
                    ...
                    return invIi.vmult(GA.rotational, tmp$1), result += tmp$1.dot(GA.rotational), invIj.vmult(GB.rotational, tmp$1), result += tmp$1.dot(GB.rotational)
        ...
        var iMfi = new Vec3,
            ...
            ContactEquation = function (_Equation) {
                function ContactEquation(bodyA, bodyB, maxForce) {
                    var _this;
                    return void 0 === maxForce && (maxForce = 1e6), (_this = _Equation.call(this, bodyA, bodyB, 0, maxForce) || this).restitution = 0, _this.ri = new Vec3, _this.rj = new Vec3, _this.ni = new Vec3, _this
                }
            ...
            PointToPointConstraint = function (_Constraint) {
                function PointToPointConstraint(bodyA, pivotA, bodyB, pivotB, maxForce) {
                    var _this;
                    void 0 === pivotA && (pivotA = new Vec3), void 0 === pivotB && (pivotB = new Vec3), void 0 === maxForce && (maxForce = 1e6), (_this = _Constraint.call(this, bodyA, bodyB) || this).pivotA = pivotA.clone(), _this.pivotB = pivotB.clone();
                    ...
                    return _this.equations.push(x, y, z), x.minForce = y.minForce = z.minForce = -maxForce, x.maxForce = y.maxForce = z.maxForce = maxForce, x.ni.set(1, 0, 0), y.ni.set(0, 1, 0), z.ni.set(0, 0, 1), _this
                }
            ...
            ConeEquation = function (_Equation) {
                function ConeEquation(bodyA, bodyB, options) {
                    ...
                    return (_this = _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) || this).axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0), _this.axisB = options.axisB ? options.axisB.clone() : new Vec3(0, 1, 0), _this.angle = void 0 !== options.angle ? options.angle : 0, _this
                }
            ...
            RotationalEquation = function (_Equation) {
                function RotationalEquation(bodyA, bodyB, options) {
                    ...
                    void 0 === options && (options = {});
                    var maxForce = void 0 !== options.maxForce ? options.maxForce : 1e6;
                    return (_this = _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) || this).axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0), _this.axisB = options.axisB ? options.axisB.clone() : new Vec3(0, 1, 0), _this.maxAngle = Math.PI / 2, _this
                }
            ...
            ConeTwistConstraint = function (_PointToPointConstrai) {
                function ConeTwistConstraint(bodyA, bodyB, options) {
                    ...
                    (_this = _PointToPointConstrai.call(this, bodyA, pivotA, bodyB, pivotB, maxForce) || this).axisA = options.axisA ? options.axisA.clone() : new Vec3, _this.axisB = options.axisB ? options.axisB.clone() : new Vec3, _this.collideConnected = !!options.collideConnected, _this.angle = void 0 !== options.angle ? options.angle : 0;
                    ...
                    return _this.twistAngle = void 0 !== options.twistAngle ? options.twistAngle : 0, c.maxForce = 0, c.minForce = -maxForce, t.maxForce = 0, t.minForce = -maxForce, _this.equations.push(c, t), _this
                }
            ...
            DistanceConstraint = (new Vec3, new Vec3, function (_Constraint) {
                function DistanceConstraint(bodyA, bodyB, distance, maxForce) {
                    var _this;
                    void 0 === maxForce && (maxForce = 1e6), _this = _Constraint.call(this, bodyA, bodyB) || this, void 0 === distance && (distance = bodyA.position.distanceTo(bodyB.position)), _this.distance = distance;
                    var eq = _this.distanceEquation = new ContactEquation(bodyA, bodyB);
                    return _this.equations.push(eq), eq.minForce = -maxForce, eq.maxForce = maxForce, _this
                }
                return _inheritsLoose(DistanceConstraint, _Constraint), DistanceConstraint.prototype.update = function () {
                    var bodyA = this.bodyA,
                        ...
                        normal = eq.ni;
                    bodyB.position.vsub(bodyA.position, normal), normal.normalize(), normal.scale(halfDist, eq.ri), normal.scale(-halfDist, eq.rj)
                }, DistanceConstraint
            }(Constraint)),
            LockConstraint = function (_PointToPointConstrai) {
                function LockConstraint(bodyA, bodyB, options) {
                    ...
                    var maxForce = void 0 !== options.maxForce ? options.maxForce : 1e6,
                        ...
                        pivotB = new Vec3,
                        halfWay = new Vec3;
                    bodyA.position.vadd(bodyB.position, halfWay), halfWay.scale(.5, halfWay), bodyB.pointToLocalFrame(halfWay, pivotB), bodyA.pointToLocalFrame(halfWay, pivotA), (_this = _PointToPointConstrai.call(this, bodyA, pivotA, bodyB, pivotB, maxForce) || this).xA = bodyA.vectorToLocalFrame(Vec3.UNIT_X), _this.xB = bodyB.vectorToLocalFrame(Vec3.UNIT_X), _this.yA = bodyA.vectorToLocalFrame(Vec3.UNIT_Y), _this.yB = bodyB.vectorToLocalFrame(Vec3.UNIT_Y), _this.zA = bodyA.vectorToLocalFrame(Vec3.UNIT_Z), _this.zB = bodyB.vectorToLocalFrame(Vec3.UNIT_Z);
                ...
                return _inheritsLoose(LockConstraint, _PointToPointConstrai), LockConstraint.prototype.update = function () {
                    ...
                    _PointToPointConstrai.prototype.update.call(this), bodyA.vectorToWorldFrame(this.xA, r1.axisA), bodyB.vectorToWorldFrame(this.yB, r1.axisB), bodyA.vectorToWorldFrame(this.yA, r2.axisA), bodyB.vectorToWorldFrame(this.zB, r2.axisB), bodyA.vectorToWorldFrame(this.zA, r3.axisA), bodyB.vectorToWorldFrame(this.xB, r3.axisB)
                }, LockConstraint
            }(PointToPointConstraint),
            RotationalMotorEquation = (new Vec3, new Vec3, function (_Equation) {
                function RotationalMotorEquation(bodyA, bodyB, maxForce) {
                    var _this;
                    return void 0 === maxForce && (maxForce = 1e6), (_this = _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) || this).axisA = new Vec3, _this.axisB = new Vec3, _this.targetVelocity = 0, _this
                }
            ...
            HingeConstraint = function (_PointToPointConstrai) {
                function HingeConstraint(bodyA, bodyB, options) {
                    ...
                    var maxForce = void 0 !== options.maxForce ? options.maxForce : 1e6,
                        pivotA = options.pivotA ? options.pivotA.clone() : new Vec3,
                        pivotB = options.pivotB ? options.pivotB.clone() : new Vec3;
                    ((_this = _PointToPointConstrai.call(this, bodyA, pivotA, bodyB, pivotB, maxForce) || this).axisA = options.axisA ? options.axisA.clone() : new Vec3(1, 0, 0)).normalize(), (_this.axisB = options.axisB ? options.axisB.clone() : new Vec3(1, 0, 0)).normalize(), _this.collideConnected = !!options.collideConnected;
                    ...
                    return motor.enabled = !1, _this.equations.push(rotational1, rotational2, motor), _this
                }
            ...
            FrictionEquation = function (_Equation) {
                function FrictionEquation(bodyA, bodyB, slipForce) {
                    var _this;
                    return (_this = _Equation.call(this, bodyA, bodyB, -slipForce, slipForce) || this).ri = new Vec3, _this.rj = new Vec3, _this.t = new Vec3, _this
                }
        ...
        var Material = function Material(options) {
            void 0 === options && (options = {});
            var name = "";
            "string" == typeof options && (name = options, options = {}), this.name = name, this.id = Material.idCounter++, this.friction = void 0 !== options.friction ? options.friction : -1, this.restitution = void 0 !== options.restitution ? options.restitution : -1
        };
        Material.idCounter = 0;
        var Spring = function () {
                function Spring(bodyA, bodyB, options) {
                    void 0 === options && (options = {}), this.restLength = "number" == typeof options.restLength ? options.restLength : 1, this.stiffness = options.stiffness || 100, this.damping = options.damping || 1, this.bodyA = bodyA, this.bodyB = bodyB, this.localAnchorA = new Vec3, this.localAnchorB = new Vec3, options.localAnchorA && this.localAnchorA.copy(options.localAnchorA), options.localAnchorB && this.localAnchorB.copy(options.localAnchorB), options.worldAnchorA && this.setWorldAnchorA(options.worldAnchorA), options.worldAnchorB && this.setWorldAnchorB(options.worldAnchorB)
                }
                ...
                return _proto.addWheel = function (options) {
                    ...
                    for (var hitNormalWorldScaledWithProj = new Vec3, fwd = new Vec3, vel = new Vec3, _i3 = 0; _i3 < numWheels; _i3++) {
                        ...
                        if (_wheel.isInContact) {
                            ...
                            _wheel.raycastResult.hitNormalWorld.scale(proj, hitNormalWorldScaledWithProj), fwd.vsub(hitNormalWorldScaledWithProj, fwd);
                            var proj2 = fwd.dot(vel);
                            _wheel.deltaRotation = m * proj2 * timeStep / _wheel.radius
                        }!_wheel.sliding && _wheel.isInContact || 0 === _wheel.engineForce || !_wheel.useCustomSlidingRotationalSpeed || (_wheel.deltaRotation = (_wheel.engineForce > 0 ? 1 : -1) * _wheel.customSlidingRotationalSpeed * timeStep), Math.abs(_wheel.brake) > Math.abs(_wheel.engineForce) && (_wheel.deltaRotation = 0), _wheel.rotation += _wheel.deltaRotation, _wheel.deltaRotation *= .99
                    }
                    ...
                    this.constraints;
                    world.removeBody(this.chassisBody), world.removeEventListener("preStep", this.preStepCallback), this.world = null
                    ...
                    for (var surfNormalWS_scaled_proj = updateFriction_surfNormalWS_scaled_proj, wheelInfos = this.wheelInfos, numWheels = wheelInfos.length, chassisBody = this.chassisBody, forwardWS = updateFriction_forwardWS, axle = updateFriction_axle, i = 0; i < numWheels; i++) {
                        ...
                        wheel.sideImpulse = 0, wheel.forwardImpulse = 0, forwardWS[i] || (forwardWS[i] = new Vec3), axle[i] || (axle[i] = new Vec3)
                    }
                    for (var _i4 = 0; _i4 < numWheels; _i4++) {
                        ...
                        if (_groundObject) {
                            ...
                            surfNormalWS.scale(proj, surfNormalWS_scaled_proj), axlei.vsub(surfNormalWS_scaled_proj, axlei), axlei.normalize(), surfNormalWS.cross(axlei, forwardWS[_i4]), forwardWS[_i4].normalize(), _wheel2.sideImpulse = resolveSingleBilateral(chassisBody, _wheel2.raycastResult.hitPointWorld, _groundObject, _wheel2.raycastResult.hitPointWorld, axlei), _wheel2.sideImpulse *= sideFrictionStiffness2
                        }
                    }
                    this.sliding = !1;
                    ...
                    for (var _i7 = 0; _i7 < numWheels; _i7++) {
                        ...
                        if (0 !== _wheel5.sideImpulse) {
                            ...
                            axle[_i7].scale(_wheel5.sideImpulse, sideImp), chassisBody.vectorToLocalFrame(rel_pos, rel_pos), rel_pos["xyz" [this.indexUpAxis]] *= _wheel5.rollInfluence, chassisBody.vectorToWorldFrame(rel_pos, rel_pos), chassisBody.applyImpulse(sideImp, rel_pos), sideImp.scale(-1, sideImp), _groundObject3.applyImpulse(sideImp, rel_pos2)
                        }
                    }
                }, RaycastVehicle
            }(),
        ...
        var Sphere = function (_Shape) {
            ...
            RigidVehicle = function () {
                function RigidVehicle(options) {
                    void 0 === options && (options = {}), this.wheelBodies = [], this.coordinateSystem = void 0 !== options.coordinateSystem ? options.coordinateSystem.clone() : new Vec3(1, 2, 3), options.chassisBody ? this.chassisBody = options.chassisBody : this.chassisBody = new Body({
                        mass: 1,
                ...
                return _proto.addWheel = function (options) {
                    ...
                    axis.scale(value, torque$1), wheelBody.vectorToWorldFrame(torque$1, torque$1), bodyTorque.vadd(torque$1, bodyTorque)
                }, _proto.addToWorld = function (world) {
            ...
            SPHSystem = function () {
                ...
                return _proto.add = function (particle) {
                    ...
                    for (var a_pressure = SPHSystem_update_a_pressure, a_visc = SPHSystem_update_a_visc, gradW = SPHSystem_update_gradW, r_vec = SPHSystem_update_r_vec, u = SPHSystem_update_u, _i = 0; _i !== N; _i++) {
                        ...
                        a_visc.scale(particle.mass, a_visc), a_pressure.scale(particle.mass, a_pressure), particle.force.vadd(a_visc, particle.force), particle.force.vadd(a_pressure, particle.force)
                    }
                }, _proto.w = function (r) {
            ...
            Particle = function (_Shape) {
                ...
                return _proto.calculateLocalInertia = function (mass, target) {
                    return void 0 === target && (target = new Vec3), target.set(0, 0, 0), target
                }, _proto.volume = function () {
                    return 0
                }, _proto.updateBoundingSphereRadius = function () {
            ...
            Plane = function (_Shape) {
                function Plane() {
                    ...
                    }) || this).worldNormal = new Vec3, _this.worldNormalNeedsUpdate = !0, _this.boundingSphereRadius = Number.MAX_VALUE, _this
                }
                ...
                return _proto.computeWorldNormal = function (quat) {
                    ...
                    min.set(-maxVal, -maxVal, -maxVal), max.set(maxVal, maxVal, maxVal), 1 === tempNormal.x ? max.x = pos.x : -1 === tempNormal.x && (min.x = pos.x), 1 === tempNormal.y ? max.y = pos.y : -1 === tempNormal.y && (min.y = pos.y), 1 === tempNormal.z ? max.z = pos.z : -1 === tempNormal.z && (min.z = pos.z)
                }, _proto.updateBoundingSphereRadius = function () {
            ...
            Heightfield = function (_Shape) {
                function Heightfield(data, options) {
                    ...
                    }) || this).data = data, _this.maxValue = options.maxValue, _this.minValue = options.minValue, _this.elementSize = options.elementSize, null === options.minValue && _this.updateMinValue(), null === options.maxValue && _this.updateMaxValue(), _this.cacheEnabled = !0, _this.pillarConvex = new ConvexPolyhedron, _this.pillarOffset = new Vec3, _this.updateBoundingSphereRadius(), _this._cachedPillars = {}, _this
                }
                ...
                return _proto.update = function () {
                    ...
                    lowerBound.set(xi * elementSize, yi * elementSize, data[xi][yi]), upperBound.set((xi + 1) * elementSize, (yi + 1) * elementSize, data[xi + 1][yi + 1])
        ...
        var Octree = function (_OctreeNode) {
                function Octree(aabb, options) {
                    ...
                    return void 0 === options && (options = {}), (_this = _OctreeNode.call(this, {
                        root: null,
                        aabb: aabb
                    }) || this).maxDepth = void 0 !== options.maxDepth ? options.maxDepth : 8, _this
                }
                return _inheritsLoose(Octree, _OctreeNode), Octree
            }(function () {
                function OctreeNode(options) {
                    void 0 === options && (options = {}), this.root = options.root || null, this.aabb = options.aabb ? options.aabb.clone() : new AABB, this.data = [], this.children = []
                }
                ...
                return _proto.reset = function () {
                    ...
                    return ray.getAABB(tmpAABB$1), tmpAABB$1.toLocalFrame(treeTransform, tmpAABB$1), this.aabbQuery(tmpAABB$1, result), result
                }, _proto.removeEmptyNodes = function () {
                    for (var i = this.children.length - 1; i >= 0; i--) this.children[i].removeEmptyNodes(), this.children[i].children.length || this.children[i].data.length || this.children.splice(i, 1)
                }, OctreeNode
            }()),
        ...
        Trimesh.createTorus = function (radius, tube, radialSegments, tubularSegments, arc) {
            void 0 === radius && (radius = 1), void 0 === tube && (tube = .5), void 0 === radialSegments && (radialSegments = 8), void 0 === tubularSegments && (tubularSegments = 6), void 0 === arc && (arc = 2 * Math.PI);
        ...
        var Solver = function () {
            ...
            GSSolver = function (_Solver) {
                function GSSolver() {
                    var _this;
                    return (_this = _Solver.call(this) || this).iterations = 10, _this.tolerance = 1e-7, _this
                }
                return _inheritsLoose(GSSolver, _Solver), GSSolver.prototype.solve = function (dt, world) {
                    ...
                    if (0 !== Neq) {
                        ...
                        for (iter = 0; iter !== maxIter; iter++) {
                            ...
                            for (var j = 0; j !== Neq; j++) {
                                var _c = equations[j];
                                B = Bs[j], invC = invCs[j], (lambdaj = lambda[j]) + (deltalambda = invC * (B - _c.computeGWlambda() - _c.eps * lambdaj)) < _c.minForce ? deltalambda = _c.minForce - lambdaj : lambdaj + deltalambda > _c.maxForce && (deltalambda = _c.maxForce - lambdaj), lambda[j] += deltalambda, deltalambdaTot += deltalambda > 0 ? deltalambda : -deltalambda, _c.addToWlambda(deltalambda)
                            }
                        ...
                        for (var _i3 = 0; _i3 !== Nbodies; _i3++) {
                            ...
                            _b.vlambda.vmul(_b.linearFactor, _b.vlambda), v.vadd(_b.vlambda, v), _b.wlambda.vmul(_b.angularFactor, _b.wlambda), w.vadd(_b.wlambda, w)
                        }
            ...
            SplitSolver = function (_Solver) {
                function SplitSolver(subsolver) {
                    var _this;
                    for ((_this = _Solver.call(this) || this).iterations = 10, _this.tolerance = 1e-7, _this.subsolver = subsolver, _this.nodes = [], _this.nodePool = []; _this.nodePool.length < 128;) _this.nodePool.push(_this.createNode());
                    return _this
                }
                ...
                return _proto.createNode = function () {
                    ...
                    for (var _i = 0; _i !== Nbodies; _i++) {
                        var _node = nodes[_i];
                        _node.body = bodies[_i], _node.children.length = 0, _node.eqs.length = 0, _node.visited = !1
                    }
                    for (var k = 0; k !== Neq; k++) {
                        var eq = equations[k],
        ...
        function bfs(root, visitFunc, bds, eqs) {
            for (queue.push(root), root.visited = !0, visitFunc(root, bds, eqs); queue.length;)
                for (var _node3 = queue.pop(), child = void 0; child = getUnvisitedNode(_node3.children);) child.visited = !0, visitFunc(child, bds, eqs), queue.push(child)
        }
        ...
        var Pool = function () {
            ...
            Narrowphase = function () {
                function Narrowphase(world) {
                    this.contactPointPool = [], this.frictionEquationPool = [], this.result = [], this.frictionResult = [], this.v3pool = new Vec3Pool, this.world = world, this.currentContactMaterial = world.defaultContactMaterial, this.enableFrictionReduction = !1
                }
                ...
                return _proto.createContactEquation = function (bi, bj, si, sj, overrideShapeA, overrideShapeB) {
                    ...
                    if (this.createFrictionEquationsFromContact(c, this.frictionResult) && 1 !== numContacts) {
                        ...
                        for (var bodyA = c.bi, i = (c.bj, 0); i !== numContacts; i++)(c = this.result[this.result.length - 1 - i]).bi !== bodyA ? (averageNormal.vadd(c.ni, averageNormal), averageContactPointA.vadd(c.ri, averageContactPointA), averageContactPointB.vadd(c.rj, averageContactPointB)) : (averageNormal.vsub(c.ni, averageNormal), averageContactPointA.vadd(c.rj, averageContactPointA), averageContactPointB.vadd(c.ri, averageContactPointB));
                    ...
                    xj.vsub(xi, r.ni), r.ni.normalize(), r.ri.copy(r.ni), r.rj.copy(r.ni), r.ri.scale(si.radius, r.ri), r.rj.scale(-sj.radius, r.rj), r.ri.vadd(xi, r.ri), r.ri.vsub(bi.position, r.ri), r.rj.vadd(xj, r.rj), r.rj.vsub(bj.position, r.rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                    ...
                    for (var R = si.radius, found = !1, side_ns = sphereBox_side_ns, side_ns1 = sphereBox_side_ns1, side_ns2 = sphereBox_side_ns2, side_h = null, side_penetrations = 0, side_dot1 = 0, side_dot2 = 0, side_distance = null, idx = 0, nsides = sides.length; idx !== nsides && !1 === found; idx++) {
                        ...
                        if (dot < h + R && dot > 0) {
                            ...
                            if (dot1 < h1 && dot1 > -h1 && dot2 < h2 && dot2 > -h2) {
                                ...
                                if ((null === side_distance || _dist < side_distance) && (side_distance = _dist, side_dot1 = dot1, side_dot2 = dot2, side_h = h, side_ns.copy(ns), side_ns1.copy(ns1), side_ns2.copy(ns2), side_penetrations++, justTest)) return !0
                            }
                        }
                    }
                        ...
                        for (var k = 0; 2 !== k && !found; k++)
                            for (var l = 0; 2 !== l && !found; l++)
                                if (rj.set(0, 0, 0), j ? rj.vadd(sides[0], rj) : rj.vsub(sides[0], rj), k ? rj.vadd(sides[1], rj) : rj.vsub(sides[1], rj), l ? rj.vadd(sides[2], rj) : rj.vsub(sides[2], rj), xj.vadd(rj, sphere_to_corner), sphere_to_corner.vsub(xi, sphere_to_corner), sphere_to_corner.lengthSquared() < R * R) {
                                    ...
                                    _r2.ri.copy(sphere_to_corner), _r2.ri.normalize(), _r2.ni.copy(_r2.ri), _r2.ri.scale(R, _r2.ri), _r2.rj.copy(rj), _r2.ri.vadd(xi, _r2.ri), _r2.ri.vsub(bi.position, _r2.ri), _r2.rj.vadd(xj, _r2.rj), _r2.rj.vsub(bj.position, _r2.rj), this.result.push(_r2), this.createFrictionEquationsFromContact(_r2, this.frictionResult)
                    ...
                    for (var edgeTangent = v3pool.get(), edgeCenter = v3pool.get(), r = v3pool.get(), orthogonal = v3pool.get(), dist = v3pool.get(), Nsides = sides.length, _j = 0; _j !== Nsides && !found; _j++)
                        for (var _k = 0; _k !== Nsides && !found; _k++)
                            if (_j % 3 != _k % 3) {
                                sides[_k].cross(sides[_j], edgeTangent), edgeTangent.normalize(), sides[_j].vadd(sides[_k], edgeCenter), r.copy(xi), r.vsub(edgeCenter, r), r.vsub(xj, r);
                    ...
                    if (!(xi.distanceTo(xj) > si.boundingSphereRadius + sj.boundingSphereRadius) && si.findSeparatingAxis(sj, xi, qi, xj, qj, sepAxis, faceListA, faceListB)) {
                        ...
                        for (var numContacts = 0, j = 0; j !== res.length; j++) {
                            ...
                            var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj),
                                ri = r.ri,
                                rj = r.rj;
                            sepAxis.negate(r.ni), res[j].normal.negate(q), q.scale(res[j].depth, q), res[j].point.vadd(q, ri), rj.copy(res[j].point), ri.vsub(xi, ri), rj.vsub(xj, rj), ri.vadd(xi, ri), ri.vsub(bi.position, ri), rj.vadd(xj, rj), rj.vsub(bj.position, rj), this.result.push(r), numContacts++, this.enableFrictionReduction || this.createFrictionEquationsFromContact(r, this.frictionResult)
                        }
                    ...
                    for (var normals = sj.faceNormals, faces = sj.faces, verts = sj.vertices, R = si.radius, found = !1, i = 0; i !== verts.length; i++) {
                        ...
                        if (worldCorner.vsub(xi, sphere_to_corner), sphere_to_corner.lengthSquared() < R * R) {
                            ...
                            found = !0;
                            var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                            return r.ri.copy(sphere_to_corner), r.ri.normalize(), r.ni.copy(r.ri), r.ri.scale(R, r.ri), worldCorner.vsub(xj, r.rj), r.ri.vadd(xi, r.ri), r.ri.vsub(bi.position, r.ri), r.rj.vadd(xj, r.rj), r.rj.vsub(bj.position, r.rj), this.result.push(r), void this.createFrictionEquationsFromContact(r, this.frictionResult)
                        }
                    }
                    for (var _i = 0, nfaces = faces.length; _i !== nfaces && !1 === found; _i++) {
                        ...
                        if (xi.vsub(worldPoint, worldPointToSphere), penetration < 0 && worldPointToSphere.dot(worldNormal) > 0) {
                            ...
                            for (var _j3 = 0; _j3 !== face.length; _j3++) {
                                var v1 = v3pool.get(),
                                    v2 = v3pool.get();
                                qj.vmult(verts[face[(_j3 + 1) % face.length]], v1), qj.vmult(verts[face[(_j3 + 2) % face.length]], v2), xj.vadd(v1, v1), xj.vadd(v2, v2);
                                ...
                                if (p.vsub(xi, xi_to_p), dot > 0 && dot * dot < edge.lengthSquared() && xi_to_p.lengthSquared() < R * R) {
                                    ...
                                    p.vsub(xj, _r4.rj), p.vsub(xi, _r4.ni), _r4.ni.normalize(), _r4.ni.scale(R, _r4.ri), _r4.rj.vadd(xj, _r4.rj), _r4.rj.vsub(bj.position, _r4.rj), _r4.ri.vadd(xi, _r4.ri), _r4.ri.vsub(bi.position, _r4.ri), this.result.push(_r4), this.createFrictionEquationsFromContact(_r4, this.frictionResult);
                    ...
                    if (normal.set(0, 0, 1), xi.vsub(xj, normal), normal.lengthSquared() <= sj.radius * sj.radius) {
                        if (justTest) return !0;
                        var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                        normal.normalize(), r.rj.copy(normal), r.rj.scale(sj.radius, r.rj), r.ni.copy(normal), r.ni.negate(r.ni), r.ri.set(0, 0, 0), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                    }
                    ...
                    if (xi.vsub(bj.position, relpos), normal.dot(relpos) <= 0) {
                        ...
                        normal.scale(normal.dot(xi), projected), xi.vsub(projected, projected), r.rj.copy(projected), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                    }
                    ...
                    if (local.copy(xi), local.vsub(xj, local), qj.conjugate(cqj), cqj.vmult(local, local), sj.pointIsInside(local)) {
                        ...
                        for (var i = 0, nfaces = sj.faces.length; i !== nfaces; i++) {
                            ...
                            if (null === minPenetration || Math.abs(penetration) < Math.abs(minPenetration)) {
                                if (justTest) return !0;
                                minPenetration = penetration, penetratedFaceIndex = i, penetratedFaceNormal.copy(normal)
                            }
                        }
                        if (-1 !== penetratedFaceIndex) {
                            var r = this.createContactEquation(bi, bj, si, sj, rsi, rsj);
                            penetratedFaceNormal.scale(minPenetration, worldPenetrationVec), worldPenetrationVec.vadd(xi, worldPenetrationVec), worldPenetrationVec.vsub(xj, worldPenetrationVec), r.rj.copy(worldPenetrationVec), penetratedFaceNormal.negate(r.ni), r.ri.set(0, 0, 0);
                            var ri = r.ri,
                                rj = r.rj;
                            ri.vadd(xi, ri), ri.vsub(bi.position, ri), rj.vadd(xj, rj), rj.vsub(bj.position, rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                    ...
                    for (var v = sphereTrimesh_v, radiusSquared = sphereShape.radius * sphereShape.radius, i = 0; i < triangles.length; i++)
                        for (var j = 0; j < 3; j++)
                            if (trimeshShape.getVertex(trimeshShape.indices[3 * triangles[i] + j], v), v.vsub(localSpherePos, relpos), relpos.lengthSquared() <= radiusSquared) {
                                ...
                                r.ni.copy(relpos), r.ni.normalize(), r.ri.copy(r.ni), r.ri.scale(sphereShape.radius, r.ri), r.ri.vadd(spherePos, r.ri), r.ri.vsub(sphereBody.position, r.ri), r.rj.copy(v), r.rj.vsub(trimeshBody.position, r.rj), this.result.push(r), this.createFrictionEquationsFromContact(r, this.frictionResult)
                            } for (var _i2 = 0; _i2 < triangles.length; _i2++)
                        for (var _j6 = 0; _j6 < 3; _j6++) {
                            trimeshShape.getVertex(trimeshShape.indices[3 * triangles[_i2] + _j6], edgeVertexA), trimeshShape.getVertex(trimeshShape.indices[3 * triangles[_i2] + (_j6 + 1) % 3], edgeVertexB), edgeVertexB.vsub(edgeVertexA, edgeVector), localSpherePos.vsub(edgeVertexB, tmp);
                    ...
                    for (var va = sphereTrimesh_va, vb = sphereTrimesh_vb, vc = sphereTrimesh_vc, normal = sphereTrimesh_normal, _i3 = 0, N = triangles.length; _i3 !== N; _i3++) {
                        trimeshShape.getTriangleVertices(triangles[_i3], va, vb, vc), trimeshShape.getNormal(triangles[_i3], normal), localSpherePos.vsub(va, tmp);
        ...
        Narrowphase.prototype[COLLISION_TYPES.convexParticle] = Narrowphase.prototype.convexParticle, Narrowphase.prototype[COLLISION_TYPES.boxHeightfield] = Narrowphase.prototype.boxHeightfield;
            ...
            World = function (_EventTarget) {
                function World(options) {
                    ...
                    return void 0 === options && (options = {}), (_this = _EventTarget.call(this) || this).dt = -1, _this.allowSleep = !!options.allowSleep, _this.contacts = [], _this.frictionEquations = [], _this.quatNormalizeSkip = void 0 !== options.quatNormalizeSkip ? options.quatNormalizeSkip : 0, _this.quatNormalizeFast = void 0 !== options.quatNormalizeFast && options.quatNormalizeFast, _this.time = 0, _this.stepnumber = 0, _this.default_dt = 1 / 60, _this.nextId = 0, _this.gravity = new Vec3, options.gravity && _this.gravity.copy(options.gravity), _this.broadphase = void 0 !== options.broadphase ? options.broadphase : new NaiveBroadphase, _this.bodies = [], _this.hasActiveBodies = !1, _this.solver = void 0 !== options.solver ? options.solver : new GSSolver, _this.constraints = [], _this.narrowphase = new Narrowphase(_assertThisInitialized(_this)), _this.collisionMatrix = new ArrayCollisionMatrix, _this.collisionMatrixPrevious = new ArrayCollisionMatrix, _this.bodyOverlapKeeper = new OverlapKeeper, _this.shapeOverlapKeeper = new OverlapKeeper, _this.materials = [], _this.contactmaterials = [], _this.contactMaterialTable = new TupleDictionary, _this.defaultMaterial = new Material("default"), _this.defaultContactMaterial = new ContactMaterial(_this.defaultMaterial, _this.defaultMaterial, {
                        ...
                        type: "removeBody",
                        body: null
                    }, _this.idToBodyMap = {}, _this.broadphase.setWorld(_assertThisInitialized(_this)), _this
                }
                ...
                return _proto.getContactMaterial = function (m1, m2) {
                    ...
                    return void 0 === options && (options = {}), options.mode = Ray.ALL, options.from = from, options.to = to, options.callback = callback, tmpRay$1.intersectWorld(this, options)
                }, _proto.raycastAny = function (from, to, options, result) {
                    return void 0 === options && (options = {}), options.mode = Ray.ANY, options.from = from, options.to = to, options.result = result, tmpRay$1.intersectWorld(this, options)
                }, _proto.raycastClosest = function (from, to, options, result) {
                    return void 0 === options && (options = {}), options.mode = Ray.CLOSEST, options.from = from, options.to = to, options.result = result, tmpRay$1.intersectWorld(this, options)
                    ...
                    if (void 0 === timeSinceLastCalled && (timeSinceLastCalled = 0), void 0 === maxSubSteps && (maxSubSteps = 10), 0 === timeSinceLastCalled) this.internalStep(dt), this.time += dt;
                    else {
                    ...
                    for (this.frictionEquations.length = 0, this.narrowphase.getContacts(p1, p2, this, contacts, oldcontacts, this.frictionEquations, frictionEquationPool), doProfiling && (profile.narrowphase = performance.now() - profilingStart), doProfiling && (profilingStart = performance.now()), i = 0; i < this.frictionEquations.length; i++) solver.addEquation(this.frictionEquations[i]);
        ...
        World.prototype.emitContactEvents = (additions = [], removals = [], beginContactEvent = {
            ...
            if (hasEndContact) {
                for (var _i2 = 0, _l = removals.length; _i2 < _l; _i2 += 2) endContactEvent.bodyA = this.getBodyById(removals[_i2]), endContactEvent.bodyB = this.getBodyById(removals[_i2 + 1]), this.dispatchEvent(endContactEvent);
    ...
    6: [function (require, module, exports) {
        var e = require("cannon-es"),
            t = function () {
                var e, t, r, n, o, i, s, a, u, c, m, f, l, d, p, x, y, E, h, g = [],
                    v = [],
                    w = 0,
                    T = function () {
                        ...
                        return function (n, o, i) {
                            return e.subVectors(i, n), t.subVectors(o, n), r.crossVectors(e, t), r.normalize()
                        }
                    }();
                ...
                function V(e, t) {
                    ...
                    var r = t[e[0]],
                        n = t[e[2]];
                    return m.subVectors(t[e[1]], r), f.subVectors(n, r), p.crossVectors(f, m), p.normalize(), e.normal = p.clone()
                }
                ...
                function b(e, t, r) {
                    var n = r[e[0]],
                        ...
                        i = V(e, r);
                    t.sort(function (e, t) {
                        return o[e.x / 3] = void 0 !== o[e.x / 3] ? o[e.x / 3] : i.dot(l.subVectors(e, n)), o[t.x / 3] = void 0 !== o[t.x / 3] ? o[t.x / 3] : i.dot(d.subVectors(t, n)), o[e.x / 3] - o[t.x / 3]
                    });
                    var s = t.length;
                    for (1 === s && (o[t[0].x / 3] = i.dot(l.subVectors(t[0], n))); s-- > 0 && o[t[s].x / 3] > 0;);
                    s + 1 < t.length && o[t[s + 1].x / 3] > 0 && (e.visiblePoints = t.splice(s + 1))
                }

                function R(e, t) {
                    for (var r, n = g.length, o = [e], i = t.indexOf(e.visiblePoints.pop()); n-- > 0;)(r = g[n]) !== e && V(r, t).dot(x.subVectors(t[i], t[r[0]])) > 0 && o.push(r);
                    var s, a, u, c, m = n = o.length,
                        f = 1 === n,
                        l = [],
                        d = 0,
                        p = [];
                    if (1 === o.length) l = [(r = o[0])[0], r[1], r[1], r[2], r[2], r[0]], v.indexOf(r) > -1 && v.splice(v.indexOf(r), 1), r.visiblePoints && (p = p.concat(r.visiblePoints)), g.splice(g.indexOf(r), 1);
                    else
                        for (; n-- > 0;) {
                            var y;
                            for (v.indexOf(r = o[n]) > -1 && v.splice(v.indexOf(r), 1), r.visiblePoints && (p = p.concat(r.visiblePoints)), g.splice(g.indexOf(r), 1), cEdgeIndex = 0; cEdgeIndex < 3;) {
                                for (y = !1, m = o.length, u = r[cEdgeIndex], c = r[(cEdgeIndex + 1) % 3]; m-- > 0 && !y;)
                                    if (d = 0, (s = o[m]) !== r)
                                        for (; d < 3 && !y;) a = d + 1, y = s[d] === u && s[a % 3] === c || s[d] === c && s[a % 3] === u, d++;
                                y && !f || (l.push(u), l.push(c)), cEdgeIndex++
                            }
                        }
                    n = 0;
                    for (var E, h = l.length / 2; n < h;) b(E = [l[2 * n + 1], i, l[2 * n]], p, t), g.push(E), void 0 !== E.visiblePoints && v.push(E), n++
                }
                var H = function () {
                    var e = new THREE.Vector3,
                        t = new THREE.Vector3,
                        r = new THREE.Vector3;
                    return function (n, o, i) {
                        e.subVectors(o, n), t.subVectors(i, n), r.subVectors(i, o);
                        var s = t.dot(e);
                        if (s < 0) return t.dot(t);
                        var a = e.dot(e);
                        return s >= a ? r.dot(r) : t.dot(t) - s * s / a
                    }
                }();
                return function (V) {
                    for (m = new THREE.Vector3, f = new THREE.Vector3, new THREE.Vector3, l = new THREE.Vector3, d = new THREE.Vector3, p = new THREE.Vector3, x = new THREE.Vector3, y = new THREE.Vector3, E = new THREE.Vector3, h = new THREE.Vector3, points = V.vertices, g = [], v = [], M = e = points.length, t = points.slice(0, 6), w = 0; M-- > 0;) points[M].x < t[0].x && (t[0] = points[M]), points[M].x > t[1].x && (t[1] = points[M]), points[M].y < t[2].y && (t[2] = points[M]), points[M].y < t[3].y && (t[3] = points[M]), points[M].z < t[4].z && (t[4] = points[M]), points[M].z < t[5].z && (t[5] = points[M]);
                    for (n = M = 6; M-- > 0;)
                        for (n = M - 1; n-- > 0;) w < (r = t[M].distanceToSquared(t[n])) && (w = r, o = t[M], i = t[n]);
                    for (M = 6, w = 0; M-- > 0;) r = H(o, i, t[M]), w < r && (w = r, s = t[M]);
                    for (u = T(o, i, s), c = u.dot(o), w = 0, M = e; M-- > 0;) r = Math.abs(points[M].dot(u) - c), w < r && (w = r, a = points[M]);
                    var B = points.indexOf(o),
                        z = points.indexOf(i),
                        S = points.indexOf(s),
                        O = points.indexOf(a),
                        G = [
                    ...
                    y.subVectors(i, o).normalize(), E.subVectors(s, o).normalize(), h.subVectors(a, o).normalize(), h.dot((new THREE.Vector3).crossVectors(E, y)) < 0 && (G[0].reverse(), G[1].reverse(), G[2].reverse(), G[3].reverse());
                    var C = points.slice();
                    C.splice(C.indexOf(o), 1), C.splice(C.indexOf(i), 1), C.splice(C.indexOf(s), 1), C.splice(C.indexOf(a), 1);
                    for (var M = G.length; M-- > 0;) b(G[M], C, points), void 0 !== G[M].visiblePoints && v.push(G[M]), g.push(G[M]);
                    ! function (e) {
                        for (; v.length > 0;) R(v.shift(), e)
                    }(points);
                    for (var P = g.length; P-- > 0;) V.faces[P] = new THREE.Face3(g[P][2], g[P][1], g[P][0], g[P].normal);
                    return V.normalsNeedUpdate = !0, V
                }
            }(),
            r = Math.PI / 2,
            n = {
            ...
            o = function (o, c) {
                var m;
                if ((c = c || {}).type === n.BOX) return s(o);
                if (c.type === n.CYLINDER) return function (t, n) {
                    var o, i, s, a = new THREE.Box3,
                        u = ["x", "y", "z"],
                        c = n.cylinderAxis || "y",
                        m = u.splice(u.indexOf(c), 1) && u;
                    return a.setFromObject(t), isFinite(a.min.lengthSq()) ? (i = a.max[c] - a.min[c], s = .5 * Math.max(a.max[m[0]] - a.min[m[0]], a.max[m[1]] - a.min[m[1]]), (o = new e.Cylinder(s, s, i, 12))._type = e.Shape.types.CYLINDER, o.radiusTop = s, o.radiusBottom = s, o.height = i, o.numSegments = 12, o.orientation = new e.Quaternion, o.orientation.setFromEuler("y" === c ? r : 0, "z" === c ? r : 0, 0, "XYZ").normalize(), o) : null
                }(o, c);
                if (c.type === n.SPHERE) return function (t, r) {
                    if (r.sphereRadius) return new e.Sphere(r.sphereRadius);
                    var n = a(t);
                    return n ? (n.computeBoundingSphere(), new e.Sphere(n.boundingSphere.radius)) : null
                }(o, c);
                if (c.type === n.HULL) return function (r) {
                    var n, o, i, s, u = a(r);
                    if (!u || !u.vertices.length) return null;
                    for (n = 0; n < u.vertices.length; n++) u.vertices[n].x += 1e-4 * (Math.random() - .5), u.vertices[n].y += 1e-4 * (Math.random() - .5), u.vertices[n].z += 1e-4 * (Math.random() - .5);
                    for (s = t(u), o = new Array(s.vertices.length), n = 0; n < s.vertices.length; n++) o[n] = new e.Vec3(s.vertices[n].x, s.vertices[n].y, s.vertices[n].z);
                    for (i = new Array(s.faces.length), n = 0; n < s.faces.length; n++) i[n] = [s.faces[n].a, s.faces[n].b, s.faces[n].c];
                    return new e.ConvexPolyhedron(o, i)
                }(o);
                if (c.type === n.MESH) return (m = a(o)) ? function (t) {
                    var r, n = u(m);
                    return n.length ? (r = Object.keys(n).map(Number), new e.Trimesh(n, r)) : null
                }() : null;
                if (c.type) throw new Error('[CANNON.threeToCannon] Invalid type "%s".', c.type);
                if (!(m = a(o))) return null;
                switch (m.metadata ? m.metadata.type : m.type) {
                    case "BoxGeometry":
                    ...
                    case "PlaneBufferGeometry":
                        return function (t) {
                            ...
                            var r = t.boundingBox;
                            return new e.Box(new e.Vec3((r.max.x - r.min.x) / 2 || .1, (r.max.y - r.min.y) / 2 || .1, (r.max.z - r.min.z) / 2 || .1))
                        }(m);
                    case "SphereGeometry":
                    ...
                    case "BufferGeometry":
                        return s(o);
                    default:
                        return console.warn('Unrecognized geometry: "%s". Using bounding box as shape.', m.type), i(m)
                }
            };
        ...
        function i(t) {
            ...
            t.computeBoundingBox();
            var r = t.boundingBox;
            return new e.Box(new e.Vec3((r.max.x - r.min.x) / 2, (r.max.y - r.min.y) / 2, (r.max.z - r.min.z) / 2))
        }

        function s(t) {
            var r, n, o = new THREE.Box3,
                i = t.clone();
            return i.quaternion.set(0, 0, 0, 1), i.updateMatrixWorld(), o.setFromObject(i), isFinite(o.min.lengthSq()) ? (r = new e.Box(new e.Vec3((o.max.x - o.min.x) / 2, (o.max.y - o.min.y) / 2, (o.max.z - o.min.z) / 2)), (n = o.translate(i.position.negate()).getCenter(new THREE.Vector3)).lengthSq() && (r.offset = n), r) : null
        }
        ...
        function a(e) {
            ...
            if (1 === n.length) {
                var s = new THREE.Vector3,
                    ...
                    u = new THREE.Vector3;
                return n[0].geometry.isBufferGeometry ? n[0].geometry.attributes.position && n[0].geometry.attributes.position.itemSize > 2 && o.fromBufferGeometry(n[0].geometry) : o = n[0].geometry.clone(), o.metadata = n[0].geometry.metadata, n[0].updateMatrixWorld(), n[0].matrixWorld.decompose(s, a, u), o.scale(u.x, u.y, u.z)
            }
            for (; r = n.pop();)
                if (r.updateMatrixWorld(), r.geometry.isBufferGeometry) {
                    if (r.geometry.attributes.position && r.geometry.attributes.position.itemSize > 2) {
                        var c = new THREE.Geometry;
                        c.fromBufferGeometry(r.geometry), i.merge(c, r.matrixWorld), c.dispose()
                    }
                } else i.merge(r.geometry, r.matrixWorld);
            return (t = new THREE.Matrix4).scale(e.scale), i.applyMatrix(t), i
        }

        function u(e) {
            return e.attributes || (e = (new THREE.BufferGeometry).fromGeometry(e)), (e.attributes.position || {}).array || []
        }
        o.Type = n, exports.threeToCannon = o
    }, {
        "cannon-es": 4
    }],
